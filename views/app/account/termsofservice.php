...
<head>
    ...
    <title>Account</title>
    <link rel="stylesheet" href="../../../style/termsofservice.css">
    ...
    <div class="main">
        <div class="container">
            ...
            <div class="content">
                ...
                Welcome to IndoCano!<br> <br>
                These terms and conditions outline the rules and regulations for the use of IndoCano's Website, located at blank. <br> <br>
                By accessing this website we assume you accept these terms and conditions. Do not continue to use IndoCano if you do not agree to take all of the terms and conditions stated on this page. <br> <br>
                The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all Agreements: "Client", "You" and "Your" refers to you, the person log on this website and compliant to the Company’s terms and conditions. "The Company", "Ourselves", "We", "Our" and "Us", refers to our Company. "Party", "Parties", or "Us", refers to both the Client and ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake the process of our assistance to the Client in the most appropriate manner for the express purpose of meeting the Client’s needs in respect of provision of the Company’s stated services, in accordance with and subject to, prevailing law of Netherlands. Any use of the above terminology or other words in the singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same. Our Terms and Conditions were created with the help of the Terms & Conditions Generator. <br> <br>
                <div class="title">Cookies</div>
                We employ the use of cookies. By accessing IndoCano, you agreed to use cookies in agreement with the IndoCano's Privacy Policy. <br> <br>
                ...
                Unless otherwise stated, IndoCano and/or its licensors own the intellectual property rights for all material on IndoCano. All intellectual property rights are reserved. You may access this from indocano for your own personal use subjected to restrictions set in these terms and conditions. <br> <br>
                You must not : <br>
                <ul>
                    <li>Republish material from IndoCano</li>
                    <li>Sell, rent, or sub-license material from IndoCano</li>
                    <li>Reproduce, duplicate, or copy material from IndoCano</li>
                    <li>Redistribute content from IndoCano</li>
                </ul>
                This Agreement shall begin on the date hereof. <br> <br>

                Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. IndoCano does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of indocano,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, indocano shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website. <br> <br>

                IndoCano reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions. <br> <br>
                ...
                You hereby grant IndoCano a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media. <br> <br>
            
                <div class="title">Hyperlinking to our Content</div>
                ...
                We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of indocano; and (d) the link is in the context of general resource information. <br> <br>
                ...
                No use of IndoCano's logo or other artwork will be allowed for linking absent a trademark license agreement. <br> <br>

                <div class="title">iFrames</div>
                ...
                <div class="title">Reservation of Rights</div>
                ...
                <div class="title">Removal of links from our website</div>
